...
@Getter
@Setter
public class StartSpringIOMetadataClient implements StartSpringIO {

    private Version version;

    private InitializrMetadataClient metaData;
    ...
    public void setMetaData(Version version, InitializrMetadataClient metaData) {
